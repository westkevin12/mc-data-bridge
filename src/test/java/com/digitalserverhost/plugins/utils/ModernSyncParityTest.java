...
public class ModernSyncParityTest {
    ...
    void testFullPlayerParityWithModernComponents() {
        ...
        try {
            ...
            source.getPersistentDataContainer().set(new NamespacedKey("databridge", "player_data"), PersistentDataType.STRING, "PlayerValue");
            ...
            assertEquals("ItemValue", targetMeta.getPersistentDataContainer().get(itemKey, PersistentDataType.STRING));
