...
mvn org.codehaus.mojo:versions-maven-plugin:2.15.0:use-latest-versions -DgenerateBackupPoms=false "-Dexcludes=io.github.secondlifegaming:*,net.kyori:*,io.papermc.paper:*,com.velocitypowered:*"
